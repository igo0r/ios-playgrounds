//
//  TableCiewController.swift
//  PrototypeCellsTableView
//
...
class TableCiewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let image = UIImage(named: transportItems[indexPath.row]) {
