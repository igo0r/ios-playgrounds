...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func configureUserNotifications() {
        let favAction = UNNotificationAction(identifier: "poop", title: "Poop it", options: [])
        let dismissAction = UNNotificationAction(identifier: "dismiss", title: "Dismiss it", options: [])
